    ...
    <Box sx={{ maxWidth: 1200, margin: 'auto', mt: 4 }}>
      <Box sx={{ 
        ...
        <Button
          ...
          onClick={() => navigate('/escola/adicionar')}
        >
          Adicionar Escola
        </Button>
      </Box>
        ...
        <Table aria-label="table with filter and pagination">
          <TableHead>
            <TableRow sx={{ backgroundColor: '#343a40' }}>
              <TableCell sx={{ color: 'white' }}>Rede de Ensino</TableCell>
              <TableCell sx={{ color: 'white' }}>Diretoria</TableCell>
              <TableCell sx={{ color: 'white' }}>Município</TableCell>
              <TableCell sx={{ color: 'white' }}>Distrito</TableCell>
              <TableCell sx={{ color: 'white' }}>Código</TableCell>
              <TableCell sx={{ color: 'white' }}>Nome da Escola</TableCell>
              <TableCell sx={{ color: 'white' }}>Tipo da Escola</TableCell>
              <TableCell sx={{ color: 'white' }}>Situação da Escola</TableCell>
